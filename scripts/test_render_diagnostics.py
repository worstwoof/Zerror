...
class RenderDiagnosticsTest(unittest.TestCase):
    ...
    def test_physics_manim_uses_blackboard_layout(self) -> None:
        ...
        self.assertIn("question_lines = self._wrap_cjk_lines", source)
        self.assertIn('title = cjk_text("原题摘要", font_size=23', source)
        self.assertIn("story_panel.scale_to_fit_width(4.75)", source)

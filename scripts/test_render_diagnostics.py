...
class RenderDiagnosticsTest(unittest.TestCase):
    ...
    def test_physics_manim_uses_blackboard_layout(self) -> None:
        ...
        self.assertIn("v_arrow = Arrow(block.get_top() + UP * 0.72", source)
        self.assertIn("block_motion = Arrow(block.get_top() + UP * 0.28", source)
        self.assertIn("B 的相对滑动\", font_size=14", source)
